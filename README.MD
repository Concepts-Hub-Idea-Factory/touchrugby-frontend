...
# TLDR; If you must modify any frontend file, do so in a separate branch and not in the main branch, else the changes made from my local computer(frontend codebase) may overwrite your work progress.